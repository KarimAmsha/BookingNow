...
//    config: ShareSheet2.Config,
//    onEnd: ((ShareSheet2.Result) -> Void)? = nil
//  ) -> some View {
//    self.background(
//      ShareSheet2(isPresented: isPresented, config: config, onEnd: onEnd)
//    )
//  }
//}
//
